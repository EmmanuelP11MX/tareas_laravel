...
<div class="row">
    ...
    <!--IF para mostrar una alerta en caso de que no se ponga titulo o descripción de la tarea -->
    @if ($errors->any())
    <div class="alert alert-danger mt-2">
        <strong>Espera!</strong> Algo salio mal..<br><br>
        <ul>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 mt-2">
                <div class="form-group">
                    ...
                    <select name="status" class="form-select" id="">
                        ...
                        <option value="Pendiente" @selected('Pediente' == $task->status)>Pendiente</option>
